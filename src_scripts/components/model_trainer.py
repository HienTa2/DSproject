...
# Custom wrapper for XGBRegressor to fix compatibility with scikit-learn
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            models = {
                ...
                "XGBRegressor": CustomXGBRegressor(),
            ...
            logging.info(f"R² Score: {best_model_score} (R² measures how well the model explains the variance in the data. "
